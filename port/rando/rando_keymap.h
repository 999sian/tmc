...
enum {
    ...
    RANDO_SPECIAL_KEY_GREGAL_SHELLS = 23,
    RANDO_SPECIAL_KEY_GREGAL_LIGHT_ARROW = 24,
    RANDO_SPECIAL_KEY_FORTRESS_PRIZE = 25,
    RANDO_SPECIAL_KEY_BELL_HP = 26,
    RANDO_SPECIAL_KEY_TINGLE_TROPHY = 27,
    RANDO_SPECIAL_KEY_DHC_KING = 28,
    RANDO_SPECIAL_KEY_SIMULATION = 29,
};
